...
export const api = {
  get: <T>(url: string, options?: FetchOptions) => apiRequest<T>(url, { method: "GET", ...options }),
  ...
  delete: <T>(url: string, options?: FetchOptions) => apiRequest<T>(url, { method: "DELETE", ...options }),
}
